...
downloadable as a zip. A dedicated-server push (SFTP / panel API / Torch) becomes
a concrete :class:`WorldDeliverer` implementation later, selected behind the
``server_push_enabled`` feature flag.
"""
